...
class LocationPredicateBuilder {
    ...
    public void setBiome(ResourceLocation resourceLocation) {
        builder.setBiome(ResourceKey.create(Registry.BIOME_REGISTRY, resourceLocation));
    }
    ...
    public void setStructure(ResourceLocation resourceLocation) {
        builder.setStructure(ResourceKey.create(Registry.STRUCTURE_REGISTRY, resourceLocation));
    }

    @Info("A resource location for the dimension.")
    public void setDimension(ResourceLocation resourceLocation) {
        builder.setDimension(ResourceKey.create(Registry.DIMENSION_REGISTRY, resourceLocation));
    }
