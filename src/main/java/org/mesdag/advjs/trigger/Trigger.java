...
public class Trigger {
    ...
    public ThrownItemPickedUpByEntityCriterion.Conditions itemPickedUpByEntity(Consumer<PickedUpItemBuilder> consumer) {
    ...
    public ThrownItemPickedUpByEntityCriterion.Conditions itemPickedUpByPlayer(Consumer<PickedUpItemBuilder> consumer) {
        PickedUpItemBuilder builder = new PickedUpItemBuilder();
        consumer.accept(builder);
    ...
    public ItemCriterion.Conditions itemUsedOnBlock(Consumer<ItemInteractWithBlockBuilder> consumer) {
        ItemInteractWithBlockBuilder builder = new ItemInteractWithBlockBuilder();
        consumer.accept(builder);
        return new ItemCriterion.Conditions(Criteria.ITEM_USED_ON_BLOCK.getId(), builder.player, builder.location, builder.item);
    }

    public ItemCriterion.Conditions allayDropItemOnBlock(Consumer<ItemInteractWithBlockBuilder> consumer) {
        ItemInteractWithBlockBuilder builder = new ItemInteractWithBlockBuilder();
        consumer.accept(builder);
        return new ItemCriterion.Conditions(Criteria.ALLAY_DROP_ITEM_ON_BLOCK.getId(), builder.player, builder.location, builder.item);
    }
    ...
    public TickCriterion.Conditions tick() {
        return new TickCriterion.Conditions(Criteria.TICK.getId(), EntityPredicate.Extended.EMPTY);
    }

    public TickCriterion.Conditions located(Consumer<PlayerPredicateBuilder> consumer){
        PlayerPredicateBuilder builder = new PlayerPredicateBuilder();
        consumer.accept(builder);
    ...
    public TickCriterion.Conditions sleptInBed() {
        return new TickCriterion.Conditions(Criteria.SLEPT_IN_BED.getId(), EntityPredicate.Extended.EMPTY);
    }
    ...
    public TickCriterion.Conditions raidWon() {
        return new TickCriterion.Conditions(Criteria.HERO_OF_THE_VILLAGE.getId(), EntityPredicate.Extended.EMPTY);
    }
    ...
    public TickCriterion.Conditions avoidVibration() {
        return new TickCriterion.Conditions(Criteria.AVOID_VIBRATION.getId(), EntityPredicate.Extended.EMPTY);
    }
