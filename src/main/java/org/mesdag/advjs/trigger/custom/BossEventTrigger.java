...
public class BossEventTrigger extends SimpleCriterionTrigger<BossEventTrigger.TriggerInstance> {
    ...
    public static class Builder extends AbstractTriggerBuilder {
        ...
        @Info("Check if darken screen. Defaults to false.")
        public void setDarkenScreen(boolean darkenScreen) {
            this.darkenScreen = darkenScreen;
        }

        @Info("Check if play boss music. Defaults to false.")
        public void setPlayBossMusic(boolean playBossMusic) {
            this.playBossMusic = playBossMusic;
        }

        @Info("Check if create world fog. Defaults to false.")
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(EntityPredicate.Composite composite, boolean darkenScreen, boolean playBossMusic, boolean createWorldFog, String key) {
            super(ID, composite);
            this.darkenScreen = darkenScreen;
            this.playBossMusic = playBossMusic;
            this.createWorldFog = createWorldFog;
