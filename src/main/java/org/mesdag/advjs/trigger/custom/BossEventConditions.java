...
public class BossEventConditions extends AbstractCriterion<BossEventConditions.Conditions> {
    ...
    @Override
    public @NotNull BossEventConditions.Conditions conditionsFromJson(@NotNull JsonObject jsonObject, EntityPredicate.@NotNull Extended composite, @NotNull AdvancementEntityPredicateDeserializer deserializationContext) {
