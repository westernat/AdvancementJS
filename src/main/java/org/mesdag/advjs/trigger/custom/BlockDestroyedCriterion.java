...
public class BlockDestroyedCriterion extends AbstractCriterion<BlockDestroyedCriterion.Conditions> {
    ...
    @Override
    public @NotNull BlockDestroyedCriterion.Conditions conditionsFromJson(@NotNull JsonObject jsonObject, EntityPredicate.@NotNull Extended composite, @NotNull AdvancementEntityPredicateDeserializer deserializationContext) {
    ...
    private static Block deserializeBlock(JsonObject jsonObject) {
        if (jsonObject.has("block")) {
            ...
            return Registry.BLOCK.getOrEmpty(resourcelocation).orElseThrow(() -> new JsonSyntaxException("Unknown block type '" + resourcelocation + "'"));
        } else {
            return null;
        }
    }
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public Conditions(EntityPredicate.Extended composite, Block block, StatePredicate statePredicate, ItemPredicate itemPredicate) {
            super(ID, composite);
            this.block = block;
            this.statePredicate = statePredicate;
